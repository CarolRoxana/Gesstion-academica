...
class HorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $fin = $request->input('hora_finalizacion');
        ...
        $conflictoSeccion = Horario::where('seccion', $seccion)
            ->whereDate('dia', $dia)
            ->where(function ($query) use ($inicio, $fin) {
                $query->whereBetween('hora_inicio', [$inicio, $fin])
                      ->orWhereBetween('hora_finalizacion', [$inicio, $fin])
    ...
    public function edit(Horario $horario)
    {
        ...
        return view('admin.horario.edit', compact('horario', 'docentes', 'unidades', 'periodos'));
    }
